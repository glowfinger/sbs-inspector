...
{#if disabled}
  <button
    class="inline-flex cursor-not-allowed items-center justify-center rounded-md border border-gray-300 bg-gray-200 px-3 py-2 text-sm font-semibold text-gray-400 shadow-sm"
    disabled="disabled"
  >
    {text}
  </button>
