<script lang="ts">
  ...
  function setService() {
    navigate(`/site/${siteId}/job/${jobId}/visit/${visitId}/work/${workId}/result/hot`);
  }

  function completeService() {
    navigate(`/site/${siteId}/job/${jobId}/visit/${visitId}/work/${workId}/confirmation/complete`);
  }

  function setInaccessible() {
    navigate(`/site/${siteId}/job/${jobId}/visit/${visitId}/work/${workId}/confirmation/inaccessible`);
  }
