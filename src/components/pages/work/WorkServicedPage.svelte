<script lang="ts">
  ...
  function submit() {
    ...
    setWorkServiced(workId, request)
      .then(complete)
...
<form class="space-y-8 divide-y divide-gray-200" on:submit|preventDefault={submit}>
    <div class="space-y-8 divide-y divide-gray-200">
        <div>
            <div>
                <h3 class="text-lg font-medium leading-6 text-gray-900">Location Serviced</h3>
            </div>
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                <div class="sm:col-span-6">
                    <label for="about" class="block text-sm font-medium text-gray-700">Any comments</label>
                    <div class="mt-1">
