  ...
  <li>
    <div class="group relative flex items-start space-x-3 py-4">
      <div class="flex-shrink-0">
        <span
          class="inline-flex h-10 w-10 items-center justify-center bg-zinc-600">
          <svg
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-sm text-zinc-500">Request a replacement unit</p>
      </div>
...
{:else}
  <li>
    <div class="group relative flex items-start space-x-3 py-4">
      ...
      <div class="min-w-0 flex-1">
        <div class="text-sm font-medium text-zinc-300">Request replacement</div>
        <p class="text-sm text-red-300 underline">Please add temperatures</p>
        <p class="text-sm text-zinc-300">Request a replacement unit</p>
      </div>
