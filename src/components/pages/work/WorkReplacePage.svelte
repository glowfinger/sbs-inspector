<script lang="ts">
  ...
  import {setWorkInaccessible, setWorkReplaced} from "../../../lib/apiServices/work/WorkApiService";
  ...
  function submit() {
    ...
    setWorkReplaced(workId, request)
      .then(complete)
...
<form class="space-y-8 divide-y divide-gray-200" on:submit|preventDefault={submit}>
    <div class="space-y-8 divide-y divide-gray-200">
        <div>
            <div>
                <h3 class="text-lg font-medium leading-6 text-gray-900">Replaced units</h3>
            </div>
