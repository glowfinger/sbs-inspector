  ...
  <li>
    <div class="group relative flex items-start space-x-3 py-4">
      <div class="flex-shrink-0">
        <span
          class="inline-flex h-10 w-10 items-center justify-center bg-zinc-700">
          <svg
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-sm text-zinc-500">Completed unit service</p>
      </div>
...
{:else}
  <li>
    <div class="group relative flex items-start space-x-3 py-4">
      ...
      <div class="min-w-0 flex-1">
        <div class="text-sm font-medium text-zinc-300">Serviced</div>
        <p class="text-sm text-red-300 underline">Please add temperatures</p>
        <p class="text-sm text-zinc-300 line-through">Completed unit service</p>
      </div>
