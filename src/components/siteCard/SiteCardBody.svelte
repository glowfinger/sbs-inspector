          ...
          <div class="flex items-center px-2 py-1 sm:px-4">
            ...
            >
              <div class="truncate">
                ...
                <div class="mt-0 flex">
                  <div class="items-left flex text-sm text-gray-500">
              ...
              <div class="mt-0 flex-shrink-0 sm:ml-5 sm:mt-0">
                <div class="flex -space-x-1 overflow-hidden"></div>
              </div>
            </div>
