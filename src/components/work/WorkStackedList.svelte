...
<div class="overflow-hidden rounded-lg bg-white shadow border-gray-700 border">
  <div class="bg-white">
    {#each groupLocationsByFloor(locationsForType(locations, job.type)) as floor}
      <div class="border-b border-gray-900 bg-gray-200 px-2 py-2 sm:px-2">
        <h3 class="text-base font-semibold leading-6 text-gray-900">Floor: {floor.floor}</h3>
      </div>

      <ul role="list" class="divide-y divide-gray-100 p-2 border-b border-gray-900">
