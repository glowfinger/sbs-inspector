<div class="mt-5 px-3">
    ...
    <div class="relative mt-1 rounded-md shadow-sm">
        ...
        <input type="text" name="search" id="search" class="block w-full rounded-md border-gray-300 pl-9 focus:border-gray-500 focus:ring-gray-500 sm:text-sm" placeholder="Search">
    </div>
</div>
