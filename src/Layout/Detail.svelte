        ...
        <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
          <div class="sm:col-span-1">
            ...
            <dd class="mt-1 text-sm text-gray-900">
              {dateFormatter(site[0].works[0].reminderAt)}
            </dd>
          </div>

          <div class="sm:col-span-1">
            <dt class="text-sm font-medium text-black-500">
              Booking not Required Date
            </dt>
            <dd class="mt-1 text-sm text-gray-900">
              {dateFormatter(site[0].works[0].updatedAt)}
            </dd>
          </div>
          ...
          <div class="sm:col-span-1">
            ...
            <dd class="mt-1 text-sm text-gray-900">
              {dateFormatter(site[0].works[0].overdueAt)}
            </dd>
          </div>
          ...
          <div class="sm:col-span-1">
            ...
            <dd class="mt-1 text-sm text-gray-900">
              {dateFormatter(site[0].works[0].bookedAt)}
            </dd>
          </div>
          ...
          <div class="sm:col-span-1">
            ...
            <dd class="mt-1 text-sm text-gray-900">
              {dateFormatter(site[0].works[0].startedAt)}
            </dd>
          </div>
          ...
          <div class="sm:col-span-1">
            ...
            <dd class="mt-1 text-sm text-gray-900">
              {dateFormatter(site[0].works[0].cancelledAt)}
            </dd>
          </div>
          ...
          <div class="sm:col-span-1">
            ...
            <dd class="mt-1 text-sm text-gray-900">Leisure Center</dd>
          </div>

          <div class="sm:col-span-1">
            <dt class="text-sm font-medium text-gray-500">Address</dt>
            <dd class="mt-1 text-sm text-gray-900">
              {site[0].address.postcode}
            </dd>
          </div>
