<script lang="ts">
  ...
  import SiteWorkHeading from '../components/SiteWorkHeading.svelte'
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            {#if site.address}
                                <dd class="mt-1 text-sm text-gray-900">{site.address.line1}</dd>
                            {:else }
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">Fugiat ipsum ipsum deserunt culpa aute sint do
                                nostrud
                                anim incididunt cillum culpa consequat. Excepteur qui ipsum aliquip consequat sint. Sit
                                id
                                ...
                                <ul role="list" class="divide-y divide-gray-200 rounded-md border border-gray-200">
                                    <li class="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                        ...
                                        <div class="ml-4 flex-shrink-0">
                                            <a href="#"
                                               class="font-medium text-gray-600 hover:text-gray-500">Download</a>
                                        </div>
                                    </li>
                                    <li class="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                                        <div class="flex w-0 flex-1 items-center">
